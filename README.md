...
[![Build Status](https://travis-ci.org/AndroidBootstrap/net-d53dev-dslfy-android.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/net-d53dev-dslfy-android)

This repository contains the source code for the [DSLFY](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=net.d53dev.dslfy.android).

Please see the [issues](https://github.net.d53dev.dslfy.android/net-d53dev-dslfy-android/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about DSLFY? Ask away on the [net-d53dev-dslfy-android discussion forum](https://groups.google.com/forum/#!forum/net-d53dev-dslfy-android).

<a href="https://play.google.com/store/apps/details?id=net.d53dev.dslfy.android" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __net.d53dev.dslfy.android__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____net.d53dev.dslfy.android__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.net.d53dev.dslfy.android.R__) will now be renamed
...
signed with a different key.  Manually uninstall DSLFY from your device and
...
DSLFY is a result of a template project I've developed over the years as well as
...
DSLFY is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.net.d53dev.dslfy.android/net-d53dev-dslfy-android/pulls).
